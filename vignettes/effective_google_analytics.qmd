...
# Available google analytics metrics and dimensions
...
#| message: false
#| column: "page"
googleAnalyticsR::ga_auth(email = "seandavi@gmail.com")
metrics_metadata <- googleAnalyticsR::ga_meta()
metrics_metadata |>
    dplyr::filter(
        status != "DEPRECATED",
    ) |>
    ...
    DT::datatable(options = list(filter = "top", pageLength = 25), rownames = FALSE, width = "100%")
```
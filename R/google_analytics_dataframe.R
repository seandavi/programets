...
#' @param filters Optional filters to apply to the data (e.g., "ga:country==United States").
#' @param sort Optional sorting for the data (e.g., "-ga:sessions").
#'
#' @return A dataframe containing the Google Analytics data.
#'
#' @export
google_analytics_dataframe <- function(property_id, start_date, end_date, metrics, dimensions, filters = NULL, sort = NULL) {
